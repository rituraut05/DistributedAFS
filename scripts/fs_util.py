...
def get_fs_signal_name(test_case):
    i = 0
    while True:
...
def kill_client(host: str):
    """
    Kill a remote client.
    """
    # grep_cmd = "ps -ef | grep afs_client | grep -v grep | awk '{print $2}'"
    # ssh_cmd = f'ssh {host} kill -9 {grep_cmd}'
