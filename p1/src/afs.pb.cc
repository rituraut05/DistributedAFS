...
PROTOBUF_CONSTEXPR RenameRequest::RenameRequest(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.pathname_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.componentname_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_afs_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::afs::RenameRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::afs::RenameRequest, _impl_.pathname_),
  PROTOBUF_FIELD_OFFSET(::afs::RenameRequest, _impl_.componentname_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::afs::RenameResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::afs::RenameResponse, _impl_.fs_errno_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 57, -1, -1, sizeof(::afs::MknodRequest)},
  { 66, -1, -1, sizeof(::afs::MknodResponse)},
  ...
  { 103, -1, -1, sizeof(::afs::GetFileStatRequest)},
  { 110, -1, -1, sizeof(::afs::GetFileStatResponse)},
  { 118, -1, -1, sizeof(::afs::TestAuthRequest)},
  { 126, -1, -1, sizeof(::afs::TestAuthResponse)},
  { 133, -1, -1, sizeof(::afs::MakeDirRequest)},
  { 141, -1, -1, sizeof(::afs::MakeDirResponse)},
  { 148, -1, -1, sizeof(::afs::RemoveDirRequest)},
  { 155, -1, -1, sizeof(::afs::RemoveDirResponse)},
  { 162, -1, -1, sizeof(::afs::ListDirRequest)},
  { 169, -1, -1, sizeof(::afs::ListDirResponse)},
  { 177, -1, -1, sizeof(::afs::RenameRequest)},
  { 185, -1, -1, sizeof(::afs::RenameResponse)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::afs::_RenameRequest_default_instance_._instance,
  &::afs::_RenameResponse_default_instance_._instance,
};
...
const char descriptor_table_protodef_afs_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "v\030\003 \001(\r\"!\n\rMknodResponse\022\020\n\010fs_errno\030\001 \001"
  "(\r\"7\n\014StoreRequest\022\020\n\010pathname\030\001 \001(\t\022\025\n\r"
  "file_contents\030\002 \001(\014\"F\n\rStoreResponse\022\020\n\010"
  "fs_errno\030\001 \001(\r\022#\n\013time_modify\030\002 \001(\0132\016.af"
  "s.Timestamp\"!\n\rRemoveRequest\022\020\n\010pathname"
  "\030\001 \001(\t\"\"\n\016RemoveResponse\022\020\n\010fs_errno\030\001 \001"
  "(\r\"&\n\022GetFileStatRequest\022\020\n\010pathname\030\001 \001"
  "(\t\"F\n\023GetFileStatResponse\022\020\n\010fs_errno\030\001 "
  "\001(\r\022\035\n\006status\030\002 \001(\0132\r.afs.FileStat\"H\n\017Te"
  "stAuthRequest\022\020\n\010pathname\030\001 \001(\t\022#\n\013time_"
  "modify\030\002 \001(\0132\016.afs.Timestamp\"\'\n\020TestAuth"
  "Response\022\023\n\013has_changed\030\001 \001(\010\"0\n\016MakeDir"
  "Request\022\020\n\010pathname\030\001 \001(\t\022\014\n\004mode\030\002 \001(\005\""
  "#\n\017MakeDirResponse\022\020\n\010fs_errno\030\001 \001(\r\"$\n\020"
  "RemoveDirRequest\022\020\n\010pathname\030\001 \001(\t\"%\n\021Re"
  "moveDirResponse\022\020\n\010fs_errno\030\001 \001(\r\"\"\n\016Lis"
  "tDirRequest\022\020\n\010pathname\030\001 \001(\t\"I\n\017ListDir"
  "Response\022\020\n\010fs_errno\030\001 \001(\r\022$\n\007entries\030\002 "
  "\003(\0132\023.afs.DirectoryEntry\"8\n\rRenameReques"
  "t\022\020\n\010pathname\030\001 \001(\t\022\025\n\rcomponentname\030\002 \001"
  "(\t\"\"\n\016RenameResponse\022\020\n\010fs_errno\030\001 \001(\r*-"
  "\n\010FileMode\022\017\n\013UNSUPPORTED\020\000\022\007\n\003REG\020\001\022\007\n\003"
  "DIR\020\0022\352\005\n\021FileSystemService\022,\n\004Ping\022\020.af"
  "s.PingMessage\032\020.afs.PingMessage\"\000\0220\n\005Fet"
  "ch\022\021.afs.FetchRequest\032\022.afs.FetchRespons"
  "e\"\000\0220\n\005Store\022\021.afs.StoreRequest\032\022.afs.St"
  "oreResponse\"\000\0223\n\006Remove\022\022.afs.RemoveRequ"
  "est\032\023.afs.RemoveResponse\"\000\0223\n\006Rename\022\022.a"
  "fs.RenameRequest\032\023.afs.RenameResponse\"\000\022"
  "0\n\005Mknod\022\021.afs.MknodRequest\032\022.afs.MknodR"
  "esponse\"\000\022B\n\013GetFileStat\022\027.afs.GetFileSt"
  "atRequest\032\030.afs.GetFileStatResponse\"\000\0229\n"
  "\010TestAuth\022\024.afs.TestAuthRequest\032\025.afs.Te"
  "stAuthResponse\"\000\0226\n\007MakeDir\022\023.afs.MakeDi"
  "rRequest\032\024.afs.MakeDirResponse\"\000\022<\n\tRemo"
  "veDir\022\025.afs.RemoveDirRequest\032\026.afs.Remov"
  "eDirResponse\"\000\0226\n\007ReadDir\022\023.afs.ListDirR"
  "equest\032\024.afs.ListDirResponse\"\000\022<\n\017FetchW"
  "ithStream\022\021.afs.FetchRequest\032\022.afs.Fetch"
  "Response\"\0000\001\022<\n\017StoreWithStream\022\021.afs.St"
  "oreRequest\032\022.afs.StoreResponse\"\000(\001b\006prot"
  "o3"
  ;
static ::_pbi::once_flag descriptor_table_afs_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_afs_2eproto = {
    false, false, 2162, descriptor_table_protodef_afs_2eproto,
    "afs.proto",
...
RenameRequest::RenameRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:afs.RenameRequest)
}
RenameRequest::RenameRequest(const RenameRequest& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.pathname_){}
    , decltype(_impl_.componentname_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  _impl_.componentname_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.componentname_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_componentname().empty()) {
    _this->_impl_.componentname_.Set(from._internal_componentname(), 
      _this->GetArenaForAllocation());
  }
...
// @@protoc_insertion_point(message_clear_start:afs.RenameRequest)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "afs.RenameRequest.pathname"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_componentname();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "afs.RenameRequest.componentname"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* RenameRequest::_InternalSerialize(
  ...
  if (!this->_internal_pathname().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_pathname().data(), static_cast<int>(this->_internal_pathname().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "afs.RenameRequest.pathname");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_pathname(), target);
  }

  // string componentname = 2;
  if (!this->_internal_componentname().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_componentname().data(), static_cast<int>(this->_internal_componentname().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "afs.RenameRequest.componentname");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_componentname(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:afs.RenameRequest)
  size_t total_size = 0;
...
void RenameRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:afs.RenameRequest)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!from._internal_componentname().empty()) {
    _this->_internal_set_componentname(from._internal_componentname());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void RenameRequest::CopyFrom(const RenameRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:afs.RenameRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void RenameRequest::InternalSwap(RenameRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.componentname_, lhs_arena,
      &other->_impl_.componentname_, rhs_arena
  );
}
...
RenameResponse::RenameResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:afs.RenameResponse)
}
RenameResponse::RenameResponse(const RenameResponse& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _this->_impl_.fs_errno_ = from._impl_.fs_errno_;
  // @@protoc_insertion_point(copy_constructor:afs.RenameResponse)
}
...
RenameResponse::~RenameResponse() {
  // @@protoc_insertion_point(destructor:afs.RenameResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:afs.RenameResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* RenameResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:afs.RenameResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:afs.RenameResponse)
  return target;
}

size_t RenameResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:afs.RenameResponse)
  size_t total_size = 0;
...
void RenameResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:afs.RenameResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:afs.RenameResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::afs::RenameRequest*
Arena::CreateMaybeMessage< ::afs::RenameRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::afs::RenameRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::afs::RenameResponse*
Arena::CreateMaybeMessage< ::afs::RenameResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::afs::RenameResponse >(arena);
}
