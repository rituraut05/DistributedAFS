 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status Rename(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::afs::RenameResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::afs::RenameResponse>> AsyncRename(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::afs::RenameResponse>>(AsyncRenameRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::afs::RenameResponse>> PrepareAsyncRename(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::afs::RenameResponse>>(PrepareAsyncRenameRaw(context, request, cq));
    }
    ...
    // PERFORMANCE
    // File operations
    std::unique_ptr< ::grpc::ClientReaderInterface< ::afs::FetchResponse>> FetchWithStream(::grpc::ClientContext* context, const ::afs::FetchRequest& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::afs::FetchResponse>>(FetchWithStreamRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::afs::FetchResponse>> AsyncFetchWithStream(::grpc::ClientContext* context, const ::afs::FetchRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::afs::FetchResponse>>(AsyncFetchWithStreamRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::afs::FetchResponse>> PrepareAsyncFetchWithStream(::grpc::ClientContext* context, const ::afs::FetchRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::afs::FetchResponse>>(PrepareAsyncFetchWithStreamRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientWriterInterface< ::afs::StoreRequest>> StoreWithStream(::grpc::ClientContext* context, ::afs::StoreResponse* response) {
      return std::unique_ptr< ::grpc::ClientWriterInterface< ::afs::StoreRequest>>(StoreWithStreamRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::afs::StoreRequest>> AsyncStoreWithStream(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::afs::StoreRequest>>(AsyncStoreWithStreamRaw(context, response, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::afs::StoreRequest>> PrepareAsyncStoreWithStream(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::afs::StoreRequest>>(PrepareAsyncStoreWithStreamRaw(context, response, cq));
    }
    class async_interface {
     public:
      ...
      virtual void Rename(::grpc::ClientContext* context, const ::afs::RenameRequest* request, ::afs::RenameResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void Rename(::grpc::ClientContext* context, const ::afs::RenameRequest* request, ::afs::RenameResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      ...
      // PERFORMANCE
      // File operations
      virtual void FetchWithStream(::grpc::ClientContext* context, const ::afs::FetchRequest* request, ::grpc::ClientReadReactor< ::afs::FetchResponse>* reactor) = 0;
      virtual void StoreWithStream(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::ClientWriteReactor< ::afs::StoreRequest>* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::afs::RenameResponse>* AsyncRenameRaw(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::afs::RenameResponse>* PrepareAsyncRenameRaw(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::grpc::CompletionQueue* cq) = 0;
    ...
    virtual ::grpc::ClientReaderInterface< ::afs::FetchResponse>* FetchWithStreamRaw(::grpc::ClientContext* context, const ::afs::FetchRequest& request) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::afs::FetchResponse>* AsyncFetchWithStreamRaw(::grpc::ClientContext* context, const ::afs::FetchRequest& request, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::afs::FetchResponse>* PrepareAsyncFetchWithStreamRaw(::grpc::ClientContext* context, const ::afs::FetchRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientWriterInterface< ::afs::StoreRequest>* StoreWithStreamRaw(::grpc::ClientContext* context, ::afs::StoreResponse* response) = 0;
    virtual ::grpc::ClientAsyncWriterInterface< ::afs::StoreRequest>* AsyncStoreWithStreamRaw(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncWriterInterface< ::afs::StoreRequest>* PrepareAsyncStoreWithStreamRaw(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status Rename(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::afs::RenameResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::afs::RenameResponse>> AsyncRename(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::afs::RenameResponse>>(AsyncRenameRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::afs::RenameResponse>> PrepareAsyncRename(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::afs::RenameResponse>>(PrepareAsyncRenameRaw(context, request, cq));
    }
    ...
    std::unique_ptr< ::grpc::ClientReader< ::afs::FetchResponse>> FetchWithStream(::grpc::ClientContext* context, const ::afs::FetchRequest& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::afs::FetchResponse>>(FetchWithStreamRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::afs::FetchResponse>> AsyncFetchWithStream(::grpc::ClientContext* context, const ::afs::FetchRequest& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::afs::FetchResponse>>(AsyncFetchWithStreamRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::afs::FetchResponse>> PrepareAsyncFetchWithStream(::grpc::ClientContext* context, const ::afs::FetchRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::afs::FetchResponse>>(PrepareAsyncFetchWithStreamRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientWriter< ::afs::StoreRequest>> StoreWithStream(::grpc::ClientContext* context, ::afs::StoreResponse* response) {
      return std::unique_ptr< ::grpc::ClientWriter< ::afs::StoreRequest>>(StoreWithStreamRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriter< ::afs::StoreRequest>> AsyncStoreWithStream(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriter< ::afs::StoreRequest>>(AsyncStoreWithStreamRaw(context, response, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriter< ::afs::StoreRequest>> PrepareAsyncStoreWithStream(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncWriter< ::afs::StoreRequest>>(PrepareAsyncStoreWithStreamRaw(context, response, cq));
    }
    class async final :
     ...
     public:
      ...
      void Rename(::grpc::ClientContext* context, const ::afs::RenameRequest* request, ::afs::RenameResponse* response, std::function<void(::grpc::Status)>) override;
      void Rename(::grpc::ClientContext* context, const ::afs::RenameRequest* request, ::afs::RenameResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      ...
      void FetchWithStream(::grpc::ClientContext* context, const ::afs::FetchRequest* request, ::grpc::ClientReadReactor< ::afs::FetchResponse>* reactor) override;
      void StoreWithStream(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::ClientWriteReactor< ::afs::StoreRequest>* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::afs::RenameResponse>* AsyncRenameRaw(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::afs::RenameResponse>* PrepareAsyncRenameRaw(::grpc::ClientContext* context, const ::afs::RenameRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    ::grpc::ClientReader< ::afs::FetchResponse>* FetchWithStreamRaw(::grpc::ClientContext* context, const ::afs::FetchRequest& request) override;
    ::grpc::ClientAsyncReader< ::afs::FetchResponse>* AsyncFetchWithStreamRaw(::grpc::ClientContext* context, const ::afs::FetchRequest& request, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncReader< ::afs::FetchResponse>* PrepareAsyncFetchWithStreamRaw(::grpc::ClientContext* context, const ::afs::FetchRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientWriter< ::afs::StoreRequest>* StoreWithStreamRaw(::grpc::ClientContext* context, ::afs::StoreResponse* response) override;
    ::grpc::ClientAsyncWriter< ::afs::StoreRequest>* AsyncStoreWithStreamRaw(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncWriter< ::afs::StoreRequest>* PrepareAsyncStoreWithStreamRaw(::grpc::ClientContext* context, ::afs::StoreResponse* response, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_FetchWithStream_;
    const ::grpc::internal::RpcMethod rpcmethod_StoreWithStream_;
  };
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status Rename(::grpc::ServerContext* context, const ::afs::RenameRequest* request, ::afs::RenameResponse* response);
    ...
    // PERFORMANCE
    // File operations
    virtual ::grpc::Status FetchWithStream(::grpc::ServerContext* context, const ::afs::FetchRequest* request, ::grpc::ServerWriter< ::afs::FetchResponse>* writer);
    virtual ::grpc::Status StoreWithStream(::grpc::ServerContext* context, ::grpc::ServerReader< ::afs::StoreRequest>* reader, ::afs::StoreResponse* response);
  };
  ...
  class WithAsyncMethod_Rename : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status Rename(::grpc::ServerContext* /*context*/, const ::afs::RenameRequest* /*request*/, ::afs::RenameResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestRename(::grpc::ServerContext* context, ::afs::RenameRequest* request, ::grpc::ServerAsyncResponseWriter< ::afs::RenameResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  template <class BaseClass>
  class WithAsyncMethod_FetchWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_FetchWithStream() {
      ::grpc::Service::MarkMethodAsync(11);
    }
    ~WithAsyncMethod_FetchWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchWithStream(::grpc::ServerContext* /*context*/, const ::afs::FetchRequest* /*request*/, ::grpc::ServerWriter< ::afs::FetchResponse>* /*writer*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestFetchWithStream(::grpc::ServerContext* context, ::afs::FetchRequest* request, ::grpc::ServerAsyncWriter< ::afs::FetchResponse>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncServerStreaming(11, context, request, writer, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithAsyncMethod_StoreWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_StoreWithStream() {
      ::grpc::Service::MarkMethodAsync(12);
    }
    ~WithAsyncMethod_StoreWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StoreWithStream(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::afs::StoreRequest>* /*reader*/, ::afs::StoreResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestStoreWithStream(::grpc::ServerContext* context, ::grpc::ServerAsyncReader< ::afs::StoreResponse, ::afs::StoreRequest>* reader, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncClientStreaming(12, context, reader, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_Ping<WithAsyncMethod_Fetch<WithAsyncMethod_Store<WithAsyncMethod_Remove<WithAsyncMethod_Rename<WithAsyncMethod_Mknod<WithAsyncMethod_GetFileStat<WithAsyncMethod_TestAuth<WithAsyncMethod_MakeDir<WithAsyncMethod_RemoveDir<WithAsyncMethod_ReadDir<WithAsyncMethod_FetchWithStream<WithAsyncMethod_StoreWithStream<Service > > > > > > > > > > > > > AsyncService;
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_Rename() {
      ::grpc::Service::MarkMethodCallback(4,
          new ::grpc::internal::CallbackUnaryHandler< ::afs::RenameRequest, ::afs::RenameResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::afs::RenameRequest* request, ::afs::RenameResponse* response) { return this->Rename(context, request, response); }));}
    void SetMessageAllocatorFor_Rename(
        ::grpc::MessageAllocator< ::afs::RenameRequest, ::afs::RenameResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(4);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::afs::RenameRequest, ::afs::RenameResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* Rename(
      ::grpc::CallbackServerContext* /*context*/, const ::afs::RenameRequest* /*request*/, ::afs::RenameResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithCallbackMethod_FetchWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_FetchWithStream() {
      ::grpc::Service::MarkMethodCallback(11,
          new ::grpc::internal::CallbackServerStreamingHandler< ::afs::FetchRequest, ::afs::FetchResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::afs::FetchRequest* request) { return this->FetchWithStream(context, request); }));
    }
    ~WithCallbackMethod_FetchWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchWithStream(::grpc::ServerContext* /*context*/, const ::afs::FetchRequest* /*request*/, ::grpc::ServerWriter< ::afs::FetchResponse>* /*writer*/) override {
    ...
    virtual ::grpc::ServerWriteReactor< ::afs::FetchResponse>* FetchWithStream(
      ::grpc::CallbackServerContext* /*context*/, const ::afs::FetchRequest* /*request*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_StoreWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_StoreWithStream() {
      ::grpc::Service::MarkMethodCallback(12,
          new ::grpc::internal::CallbackClientStreamingHandler< ::afs::StoreRequest, ::afs::StoreResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, ::afs::StoreResponse* response) { return this->StoreWithStream(context, response); }));
    }
    ~WithCallbackMethod_StoreWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StoreWithStream(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::afs::StoreRequest>* /*reader*/, ::afs::StoreResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerReadReactor< ::afs::StoreRequest>* StoreWithStream(
      ::grpc::CallbackServerContext* /*context*/, ::afs::StoreResponse* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_Ping<WithCallbackMethod_Fetch<WithCallbackMethod_Store<WithCallbackMethod_Remove<WithCallbackMethod_Rename<WithCallbackMethod_Mknod<WithCallbackMethod_GetFileStat<WithCallbackMethod_TestAuth<WithCallbackMethod_MakeDir<WithCallbackMethod_RemoveDir<WithCallbackMethod_ReadDir<WithCallbackMethod_FetchWithStream<WithCallbackMethod_StoreWithStream<Service > > > > > > > > > > > > > CallbackService;
  ...
  template <class BaseClass>
  class WithGenericMethod_FetchWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_FetchWithStream() {
      ::grpc::Service::MarkMethodGeneric(11);
    }
    ~WithGenericMethod_FetchWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchWithStream(::grpc::ServerContext* /*context*/, const ::afs::FetchRequest* /*request*/, ::grpc::ServerWriter< ::afs::FetchResponse>* /*writer*/) override {
  ...
  template <class BaseClass>
  class WithGenericMethod_StoreWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_StoreWithStream() {
      ::grpc::Service::MarkMethodGeneric(12);
    }
    ~WithGenericMethod_StoreWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StoreWithStream(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::afs::StoreRequest>* /*reader*/, ::afs::StoreResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_FetchWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_FetchWithStream() {
      ::grpc::Service::MarkMethodRaw(11);
    }
    ~WithRawMethod_FetchWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchWithStream(::grpc::ServerContext* /*context*/, const ::afs::FetchRequest* /*request*/, ::grpc::ServerWriter< ::afs::FetchResponse>* /*writer*/) override {
    ...
    void RequestFetchWithStream(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncWriter< ::grpc::ByteBuffer>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncServerStreaming(11, context, request, writer, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_StoreWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_StoreWithStream() {
      ::grpc::Service::MarkMethodRaw(12);
    }
    ~WithRawMethod_StoreWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StoreWithStream(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::afs::StoreRequest>* /*reader*/, ::afs::StoreResponse* /*response*/) override {
    ...
    void RequestStoreWithStream(::grpc::ServerContext* context, ::grpc::ServerAsyncReader< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* reader, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncClientStreaming(12, context, reader, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_FetchWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_FetchWithStream() {
      ::grpc::Service::MarkMethodRawCallback(11,
          new ::grpc::internal::CallbackServerStreamingHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const::grpc::ByteBuffer* request) { return this->FetchWithStream(context, request); }));
    }
    ~WithRawCallbackMethod_FetchWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchWithStream(::grpc::ServerContext* /*context*/, const ::afs::FetchRequest* /*request*/, ::grpc::ServerWriter< ::afs::FetchResponse>* /*writer*/) override {
    ...
    virtual ::grpc::ServerWriteReactor< ::grpc::ByteBuffer>* FetchWithStream(
      ::grpc::CallbackServerContext* /*context*/, const ::grpc::ByteBuffer* /*request*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithRawCallbackMethod_StoreWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_StoreWithStream() {
      ::grpc::Service::MarkMethodRawCallback(12,
          new ::grpc::internal::CallbackClientStreamingHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, ::grpc::ByteBuffer* response) { return this->StoreWithStream(context, response); }));
    }
    ~WithRawCallbackMethod_StoreWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StoreWithStream(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::afs::StoreRequest>* /*reader*/, ::afs::StoreResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerReadReactor< ::grpc::ByteBuffer>* StoreWithStream(
   ...
   public:
    WithStreamedUnaryMethod_Rename() {
      ::grpc::Service::MarkMethodStreamed(4,
        new ::grpc::internal::StreamedUnaryHandler<
          ::afs::RenameRequest, ::afs::RenameResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::afs::RenameRequest, ::afs::RenameResponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedRename(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::afs::RenameRequest,::afs::RenameResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_Ping<WithStreamedUnaryMethod_Fetch<WithStreamedUnaryMethod_Store<WithStreamedUnaryMethod_Remove<WithStreamedUnaryMethod_Rename<WithStreamedUnaryMethod_Mknod<WithStreamedUnaryMethod_GetFileStat<WithStreamedUnaryMethod_TestAuth<WithStreamedUnaryMethod_MakeDir<WithStreamedUnaryMethod_RemoveDir<WithStreamedUnaryMethod_ReadDir<Service > > > > > > > > > > > StreamedUnaryService;
  template <class BaseClass>
  class WithSplitStreamingMethod_FetchWithStream : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithSplitStreamingMethod_FetchWithStream() {
          ...
          ::afs::FetchRequest, ::afs::FetchResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerSplitStreamer<
                     ::afs::FetchRequest, ::afs::FetchResponse>* streamer) {
                       return this->StreamedFetchWithStream(context,
                         streamer);
                  }));
    }
    ~WithSplitStreamingMethod_FetchWithStream() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status FetchWithStream(::grpc::ServerContext* /*context*/, const ::afs::FetchRequest* /*request*/, ::grpc::ServerWriter< ::afs::FetchResponse>* /*writer*/) override {
    ...
    virtual ::grpc::Status StreamedFetchWithStream(::grpc::ServerContext* context, ::grpc::ServerSplitStreamer< ::afs::FetchRequest,::afs::FetchResponse>* server_split_streamer) = 0;
  };
  typedef WithSplitStreamingMethod_FetchWithStream<Service > SplitStreamedService;
