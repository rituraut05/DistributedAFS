...
FileSystemService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_Create_(FileSystemService_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status FileSystemService::Stub::Create(::grpc::ClientContext* context, const ::afs::CreateRequest& request, ::afs::CreateResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::afs::CreateRequest, ::afs::CreateResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_Create_, context, request, response);
}

void FileSystemService::Stub::async::Create(::grpc::ClientContext* context, const ::afs::CreateRequest* request, ::afs::CreateResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::afs::CreateRequest, ::afs::CreateResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_Create_, context, request, response, std::move(f));
}

void FileSystemService::Stub::async::Create(::grpc::ClientContext* context, const ::afs::CreateRequest* request, ::afs::CreateResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_Create_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::afs::CreateResponse>* FileSystemService::Stub::PrepareAsyncCreateRaw(::grpc::ClientContext* context, const ::afs::CreateRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::afs::CreateResponse, ::afs::CreateRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_Create_, context, request);
}

::grpc::ClientAsyncResponseReader< ::afs::CreateResponse>* FileSystemService::Stub::AsyncCreateRaw(::grpc::ClientContext* context, const ::afs::CreateRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
FileSystemService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< FileSystemService::Service, ::afs::CreateRequest, ::afs::CreateResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](FileSystemService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::afs::CreateRequest* req,
             ::afs::CreateResponse* resp) {
...
::grpc::Status FileSystemService::Service::Create(::grpc::ServerContext* context, const ::afs::CreateRequest* request, ::afs::CreateResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
